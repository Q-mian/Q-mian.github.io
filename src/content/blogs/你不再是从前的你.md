...
.main-content { position: relative; z-index: 2; max-width: 900px; margin: 3rem auto; padding: 2rem; background: rgba(255, 255, 255, 0.35); border-radius: 8px; box-shadow: 0 10px 30px rgba(55, 55, 55, 0.5); color: #f3f3f3; }
</style>
